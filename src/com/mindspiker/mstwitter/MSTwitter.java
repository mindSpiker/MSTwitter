...
public class MSTwitter {
	...
	private MSTwitter.MSTwitterResultReceiver mResultReceiver;
	 ...
	 */
	public MSTwitter(Activity activity, String consumerKey, String consumerSecret, MSTwitter.MSTwitterResultReceiver resultReceiver) throws IllegalArgumentException {
		if (activity == null) {
